...
Square* mPiece(int row, int col, char piece) {
    ...
    else if (piece == 'k') s = new King(row, col, Colour::BLACK, false);
    else if (piece == 'q') s = new Queen(row, col, Colour::BLACK);
    else if (piece == 'r') s = new Rook(row, col, Colour::BLACK, false);
    ...
    else if (piece == 'K') s = new King(row, col, Colour::WHITE, false);
    else if (piece == 'Q') s = new Queen(row, col, Colour::WHITE);
    else if (piece == 'R') s = new Rook(row, col, Colour::WHITE, false);
